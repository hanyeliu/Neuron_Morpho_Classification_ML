...
# With Labels
# Merge all the files from corrected files to one single file skipping titles
def merger_labelled(Preprocessed_file,file_name):
    # Merge all features files into one
    fout=open(Preprocessed_file,"a")
    fout.write("Class,")
    for n in xrange(1,74):
...
#################################################################################################
## Preprocess the extracted features taking into account all the features
#preprocessing_module(Extracted_Features,Coma_Features,Corrected_Features,Norm)
#
## Preprocess the extracted features taking into account only selected the features
##preprocessing_module_features_selected(Extracted_Features,Coma_Features,Corrected_Features)
#
## Merge files without labels
#merger(Preprocessed_file,file_name)
## Merge files with labels
##merger_labelled(Preprocessed_file,file_name) #with features labels
#
## Similarity matrix without labels
##similarity_matrix(Corrected_Features,similarity) # without class labels
## Similarity matrix with labels
#neuron_similarity_matrix_labelled(Preprocessed_file,similarity) # with class labels
